...
public class PlatformCollider : MonoBehaviour {
    ...
    /*BoxCollider topCol, botCol;

    // Use this for initialization
	void Start () {
        topCol = GetComponentInChildren<BoxCollider>();
        botCol = GetComponentInChildren<BoxCollider>();
	}
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.gameObject.GetComponent<BoxCollider>() == botCol)
        {
    ...
    {
        if (other.GetComponent<BoxCollider>() == botCol)
        {
            topCol.enabled = true;
        }
    }*/
